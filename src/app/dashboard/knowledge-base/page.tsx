...
export default function KnowledgeBasePage() {
 ...
 className="px-4 py-2 bg-zinc-950 text-white rounded-lg text-sm font-medium hover:bg-zinc-900 transition-colors"
 >
 + Add Document
 </button>
 </div>
 ...
 type="submit"
 disabled={addSaving}
 className="px-4 py-2 bg-zinc-950 text-white rounded-lg text-sm font-medium hover:bg-zinc-900 disabled:opacity-50 transition-colors"
 >
