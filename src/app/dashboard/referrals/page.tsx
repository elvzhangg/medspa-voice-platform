    ...
    <div className="max-w-5xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <button
          ...
          className="flex items-center gap-2 bg-[#fdf9ec] text-amber-900 border border-amber-300 text-sm font-medium px-4 py-2 rounded-lg hover:bg-amber-50 transition-colors"
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex gap-3 pt-2">
              <button
                type="submit"
                disabled={submitting}
                className="bg-[#fdf9ec] text-amber-900 border border-amber-300 text-sm font-medium px-5 py-2 rounded-lg hover:bg-amber-50 transition-colors disabled:opacity-50"
              >
