...
export default function ReferralsPage() {
 ...
 className="flex items-center gap-2 bg-stone-700 text-white text-sm font-medium px-4 py-2 rounded-lg hover:bg-stone-600 transition-colors"
 >
 ...
 type="submit"
 disabled={submitting}
 className="bg-stone-700 text-white text-sm font-medium px-5 py-2 rounded-lg hover:bg-stone-600 transition-colors disabled:opacity-50"
 >
