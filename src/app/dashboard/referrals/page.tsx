...
export default function ReferralsPage() {
 ...
 className="flex items-center gap-2 bg-zinc-950 text-white text-sm font-medium px-4 py-2 rounded-lg hover:bg-zinc-900 transition-colors"
 >
 ...
 type="submit"
 disabled={submitting}
 className="bg-zinc-950 text-white text-sm font-medium px-5 py-2 rounded-lg hover:bg-zinc-900 transition-colors disabled:opacity-50"
 >
