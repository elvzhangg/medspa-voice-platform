...
export default function ProvidersPage() {
 ...
 <button type="submit" className="px-6 py-2 bg-amber-400 text-amber-900 rounded-lg font-bold text-sm">
 Save Provider
 </button>
 </div>
 </form>
...
function ProviderCard({
 ...
 className="px-4 py-1.5 bg-amber-400 text-amber-900 rounded-lg text-xs font-semibold hover:bg-amber-500 disabled:opacity-50"
 >
