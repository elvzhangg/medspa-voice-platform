    ...
    <div className="h-full flex flex-col">
      ...
      {view === "setup" && (
        <div className="bg-white rounded-xl border border-gray-200 p-8 shadow-sm max-w-4xl animate-in fade-in slide-in-from-bottom-4 duration-300">
          ...
          <div className="space-y-4 p-6 border-t border-gray-100 mb-8 bg-indigo-50/30 rounded-xl">
            <h2 className="text-sm font-black text-indigo-900 uppercase tracking-widest flex items-center gap-2">
              ...
              Appointment Confirmation Customization
            </h2>
            ...
            <label className="block text-xs font-bold text-gray-700 uppercase tracking-wide mb-1">
              Add your custom footer (Parking, Entry Codes, etc.)
            </label>
            <textarea 
              placeholder="e.g. Please arrive 15 min early. Free parking is available in the rear lot..."
              className="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl h-24 focus:ring-2 focus:ring-indigo-500 outline-none transition-all shadow-inner"
              value={directions}
              onChange={e => setDirections(e.target.value)}
            />
            <p className="text-[10px] text-indigo-400 font-medium">This text will be appended automatically to the official confirmation message.</p>
          </div>
