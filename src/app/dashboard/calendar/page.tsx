  ...
  return (
    <div className="max-w-6xl space-y-6">
      ...
      {integration && integration.status !== "connected" && (
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-amber-500 via-amber-600 to-amber-600 p-8 shadow-lg">
                ...
                <div className="flex items-center justify-between mb-1">
                  <span
                    className={`inline-flex items-center justify-center text-xs font-bold ${
                      isToday
                        ? "bg-amber-600 text-white rounded-full w-6 h-6"
                        : inMonth
