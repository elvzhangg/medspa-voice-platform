...
export default async function DashboardPage() {
 ...
 className="flex items-center gap-2.5 w-full px-3.5 py-2.5 bg-amber-50 text-amber-900 border border-amber-300 rounded-lg text-sm font-semibold hover:bg-amber-100 border border-amber-400 transition-all shadow-sm"
 >
