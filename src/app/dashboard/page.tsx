...
export default async function DashboardPage() {
 ...
 >
 <div className="w-8 h-8 bg-gradient-to-br from-amber-300 to-amber-500 rounded-full flex items-center justify-center shrink-0">
 ...
 className="flex items-center gap-2.5 w-full px-3.5 py-2.5 bg-amber-400 text-amber-900 rounded-lg text-sm font-semibold hover:bg-amber-500 transition-all shadow-sm"
 >
