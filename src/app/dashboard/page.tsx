...
export default async function DashboardPage() {
 ...
 <StatCard
 gradient="from-stone-700 to-stone-700"
 icon={
 ...
 >
 <div className="w-8 h-8 bg-gradient-to-br from-stone-700 to-stone-700 rounded-full flex items-center justify-center shrink-0">
 ...
 className="flex items-center gap-2.5 w-full px-3.5 py-2.5 bg-stone-700 text-white rounded-lg text-sm font-semibold hover:bg-stone-600 transition-all shadow-sm"
 >
