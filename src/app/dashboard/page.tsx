...
export default async function DashboardPage() {
 ...
 >
 <div className="w-8 h-8 bg-gradient-to-br from-amber-50 to-amber-100 rounded-full flex items-center justify-center shrink-0">
 ...
 className="flex items-center gap-2.5 w-full px-3.5 py-2.5 bg-white text-amber-900 border border-amber-200 rounded-lg text-sm font-semibold hover:bg-[#fdf9ec] border border-amber-300 transition-all shadow-sm"
 >
 ...
 <Link
 href="/dashboard/calls"
 className="flex items-center gap-2.5 w-full px-3.5 py-2.5 border border-gray-200 text-gray-700 rounded-lg text-sm hover:bg-[#fdf9ec] transition-colors"
 >
