...
export default function CampaignsPage() {
 ...
 className="px-4 py-2 bg-amber-400 text-amber-900 font-bold rounded-lg hover:bg-amber-500 transition-all shadow-md shadow-amber-100 flex items-center gap-2"
 >
 ...
 required
 />
 <button type="submit" className="px-6 py-2 bg-amber-400 text-amber-900 rounded-lg font-bold">Create</button>
 ...
 <div>
 <p className="text-[10px] text-gray-400 font-bold tracking-wider mb-1">Leads</p>
 <p className="text-xl font-semibold text-gray-900">{cp.total_leads}</p>
 </div>
 <div>
 <p className="text-[10px] text-gray-400 font-bold tracking-wider mb-1">Calls</p>
 <p className="text-xl font-semibold text-gray-900">{cp.calls_made}</p>
 </div>
 <div>
 <p className="text-[10px] text-gray-400 font-bold tracking-wider mb-1">Booked</p>
 <p className="text-xl font-semibold text-amber-700">{cp.successful_bookings}</p>
 </div>
 </div>

 <Link
 href={`/dashboard/campaigns/${cp.id}`}
 className="block w-full text-center py-2 bg-amber-400 text-amber-900 rounded-lg text-sm font-bold hover:bg-amber-500 transition-all shadow-sm shadow-amber-100"
 >
 Open Campaign
 </Link>
 </div>
