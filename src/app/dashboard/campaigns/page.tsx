        ...
        <div className="mb-8 bg-white p-6 rounded-xl border-2 border-amber-200 shadow-sm">
          ...
          <form onSubmit={handleCreate} className="flex gap-4">
            <input 
              ...
              required
            />
            <button type="submit" className="px-6 py-2 bg-[#fdf9ec] text-amber-900 border border-amber-300 rounded-lg font-bold">Create</button>
            ...
            <div key={cp.id} className="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm hover:shadow-md transition-all">
              <div className="p-6">
                ...
                <Link
                  ...
                  className="block w-full text-center py-2 bg-[#fdf9ec] text-amber-900 border border-amber-300 rounded-lg text-sm font-bold hover:bg-amber-50 transition-all shadow-sm shadow-amber-100"
                >
                  Open Campaign
                </Link>
              </div>
