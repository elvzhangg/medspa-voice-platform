      ...
      <div className="flex justify-between items-center mb-8">
        ...
        <div className="flex gap-2">
          ...
          <button 
            ...
            className="px-6 py-2 bg-amber-600 text-white font-black rounded-lg hover:bg-amber-700 shadow-lg shadow-amber-100 uppercase tracking-widest text-xs"
          >
            🚀 Start sequence
          </button>
        </div>
        ...
        <div className="mb-8 bg-amber-50 p-8 rounded-2xl border-2 border-dashed border-amber-300 text-center">
          ...
          <form onSubmit={handleUpload} className="space-y-4">
            ...
            <div className="flex justify-center gap-2">
              <button type="submit" className="px-8 py-2 bg-amber-600 text-white rounded-lg font-bold">Upload leads</button>
